  ...
  render() {
    return (
      <div>
        ...
        are unable to find someone else to share experiences with. However, this project
        is an attempt to be that light, community, link, or whatever definition befits you,
        to connect people all over the world to each other from all walks of life. So put
        on your headset, stand (or sit) with the rest of us, and play like...
        </p>
        <p> - VR One World.</p>
      </div>
    );
